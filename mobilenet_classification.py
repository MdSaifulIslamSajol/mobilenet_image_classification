...
num_train_samples= 2000  #319837
num_val_samples= 400  #39995
num_test_samples= 400   #39996
...
for epoch in range(epochs):
        ...
        valid_acc_list.append(valid_acc_list)
        ...
        torch.save(model_ft.state_dict(), "/home/saiful/mobilenet_classification/saved models/document_dataset "+'_model_'+str(epoch)+'.pt')
...
plt.plot( epoch_list,train_acc_list)
plt.plot( epoch_list,valid_acc_list)
# plt.plot(valid_loss_list, epoch_list)
...
# x1_list= [0, 1, 2, 3, 4, 5] 
# y1_list = [0, 1, 4, 9, 16, 25]
# y2_list = [5, 7, 9, 14, 21, 30]
